...
import 'package:degree/login_screens/component/vetification_component.dart';
import 'package:flutter/material.dart';

import 'package:degree/login_screens/shared/data/countries.dart';
...
class _RegisterComponentState extends State<RegisterComponent> {
  ...
  final TextEditingController countryFlagController =
      TextEditingController(text: 'MN');
  String selectValue = 'MN';
  ...
  void initState() {
    super.initState();
    phoneNumberController.text = '+976';
  }

  @override
  Widget build(BuildContext context) {
    log('register screen is built');
  ...
  Widget form() {
    log('form is building in register screen');
    return Form(
      key: _formKey,
      child: Column(
        children: [
